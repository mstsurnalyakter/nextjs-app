...
const BlogsPage = () => {
  return (
    <div>
      <h3 className=" text-center my-6 text-3xl">Blog</h3>
      <div className="grid grid-cols-1 gap-6 p-10">
        {blogs.map((blog) => (
          <div
            key={blog.id}
            className="border-2 border-purple-600 p-5 space-y-3"
          >
            <h3>Title:{blog.title}</h3>
            <p>Scenario:{blog.scenario}</p>
            <p>Description:{blog.description}</p>
            <button className="bg-green-600 px-2 py-2 rounded-md">
